...
//###############################################################################################################################################
		...
		: public Util::GenRefCounted, public EventListenerPool
	{
		...
		public :
			...
			//
			//
			// custom methods: integrating XTEAM
			//
			//
			////////////////////////////////////////////////////////////////////////////////
			////////////////////////////////////////////////////////////////////////////////
			...
			// find all Models
			bool					get_models(				std::set<BON::Object> &objs);

			// add a SET member
			bool					add_set_member(			long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4,  
			...
			// remove a SET member
			bool					remove_set_member(		long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4,  
															std::string strObjectType, 
			...
			bool					find_object_by_GUID(	long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4, 
															std::string strObjectType, 
			...
			bool					update_color_to_red(	long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4, 
															std::string strObjectType);
			...
			bool					update_location_registry(					
															long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4, 
															std::string strObjectType, 
															std::vector<std::string> vectorLocationRegistry);

			// update location of an object with the x and y coordinates string
			bool					update_location(		long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4, 
															std::string strObjectType, 
															std::string strObjectPosition);
			
			// update Attributes of a class
			bool					update_additional_attributes(	
															long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4, 
															std::string strObjectType, 
															std::vector<std::string> vectorAdditionalAttributes);
			
			// update name of an object
			bool					update_name(			long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4, 
			...
			std::string				get_kind_by_info(		std::string strObjectInfo);
			
			// create an object, and update its parent
			bool					create_object(			long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4,  
															std::string strObjectType, 
			...
			bool					create_connection(		long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4,  
															std::string strObjectType, 
			...
			// destroy an object
			bool					destroy_object(			long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4,
															std::string strObjectName,
			...
			// destroy all connections that an object has
			bool					destroy_connections(	long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4);
			bool					destroy_connections(	long nGUID_1, 
															...
															long nGUID_4,
															std::string strObjectType);
			void					check_out_conn_ends(	long nGUID_1, 
															long nGUID_2, 
															long nGUID_3, 
															long nGUID_4,
